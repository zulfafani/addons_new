...
def main():
    ...
    for instance_name in instancesSS:
        ...
        integrator_transaksiMCtoSS.payment_method_from_mc('pos.payment.method', ['id', 'name', 'is_store', 'split_transactions', 'journal_id', 'config_ids'], 'Transaksi PoS Payment Method', date_from, date_to)
