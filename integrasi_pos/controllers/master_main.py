...
def main():
    ...
    for instance_name in instancesSS:
        ...
        # integrator_transaksi.transfer_warehouse_master('stock.warehouse', ['name', 'lot_stock_id'], 'Insert Warehouse')
        ...
        # integrator_transaksiMCtoSS.transfer_internal_transfers_MCtoSS('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
        # integrator_transaksiMCtoSS.transfer_goods_issue_MCtoSS('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
        # integrator_transaksiMCtoSS.transfer_goods_receipt_MCtoSS('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
