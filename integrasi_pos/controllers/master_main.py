...
def main():
    ...
    for instance_name in instancesSS:
        ...
        # integrator_master.transfer_data('hr.employee', ['name', 'mobile_phone', 'work_phone', 'work_email'], 'Sales Employee')
        ...
        # integrator_transaksi.transfer_internal_transfer('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
        ...
        integrator_transaksi.transfer_TSOutTsIn('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
        # integrator_transaksi.transfer_TSIntoStore('stock.picking', ['name', 'partner_id', 'location_id', 'picking_type_id', 'location_dest_id', 'scheduled_date', 'date_done', 'origin', 'move_ids_without_package'], 'Transaksi PoS Order Inventory')
        ...
        # integrator_transaksi.transfer_stock_adjustment('stock.move.line', ['reference', 'quantity', 'product_id', 'location_id'], 'Transaksi Adjustment Stock')
